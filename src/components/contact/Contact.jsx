...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (username === '') {
      ...
      emailjs
        .send(
          'service_eqxbr31', // Replace with your EmailJS service ID
          'template_yx7y1zo', // Replace with your EmailJS template ID templateParams,
          'WpHOilYz5oh5vjioR' // Replace with your EmailJS user ID
        )
        .then(
          (response) => {
